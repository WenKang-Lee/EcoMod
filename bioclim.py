    ...
    for arr in array_drawer_84320700:
        ...
        while out_check:
            ...
            if not cv_check:
                ...
                kde_func = kde().fit(reshp_env) # one-feature samples
                ...
                plt.legend()
                plt.show()
                out_remover = input('To remove outliers, key in to-be-retained [inclusive range], seperated by colon. '
                                    '\nFor example: 3:19 \nLeave blank to retain all values: ')
